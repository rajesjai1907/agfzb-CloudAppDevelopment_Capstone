...
def analyze_review_sentiments(text):
    api_key = "H-SaYMWhUbfqbNKdVbBrj3-M2BTCDzWYw1_wc2M2-hVP"
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/aeaf3eb1-a46b-4e8a-a1a0-e01b6cd58ab6" + "/v1/analyze"
    version = "2021-03-25"
    feature = {"sentiment"}
